...
import Form from "@/components/sections/tr/home1/Form";

export const metadata = {
  title: "Mediwali Sağlık Turizmi | İletişim",
      ...
      >
        ...
        <section style={{ paddingTop: 60 }} className="contact-page">
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-6">
                <div className="contact-page__left">
                  <h3 className="contact-page__title">İletişime Geçin</h3>
                  <p className="contact-page__text">
                    Destek ekibimizle 7/24 iletişime geçebilirsiniz. Bizimle
                    iletişime geçebilirsiniz her türlü soru ve yorum için.
                  </p>
            ...
            <div className="update_time">Güncelleme Tarihi: 29.09.2024</div>
          </div>
        </section>
