            ...
            {/* Video One Start  */}
                <section className="video-one">
                    <div className="video-one__bg"
                        style={{ backgroundImage: 'url(assets/images/main/video.webp)' }} >
                    </div>
                                    ...
                                    <div className="curved-circle">
                                        <span className="curved-circle--item">
                                            ...
                                            <ReactCurvedText width='240'
                                                ...
                                                startOffset='0'
                                                reversed={true}
                                                text='HEALTH BEAUTY DENTAL TOURISM HOSPITAL AESTHETICS'
                ...
                <ModalVideo channel='youtube' autoplay isOpen={isOpen} videoId="vfQWUggEvf4" onClose={() => setOpen(false)} />
            {/* Video One End  */}
        </>
    )
}
